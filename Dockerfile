# Ansible managed: /workspace/users/albandri10/env/ansible/roles/shell/templates/Dockerfile.j2 modified on 2014-10-25 13:23:28 by albandri on albandri-laptop-misys
#FROM        debian:jessie
