...
if [ -n "${TARGET_SLAVE}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : TARGET_SLAVE, use the default one ${NC}"
...
if [ -n "${TARGET_PLAYBOOK}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : TARGET_PLAYBOOK, use the default one ${NC}"
...
if [ -n "${DRY_RUN}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : DRY_RUN, use the default one ${NC}"
...
if [ -n "${DOCKER_RUN}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : DOCKER_RUN, use the default one ${NC}"
  export DOCKER_RUN=""
...
if [ -n "${ANSIBLE_INVENTORY}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_INVENTORY, use the default one ${NC}"
...
if [ -n "${ANSIBLE_INVENTORY_OUTPUT_DIR}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_INVENTORY_OUTPUT_DIR, use the default one ${NC}"
...
if [ -n "${JUNIT_OUTPUT_DIR}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : JUNIT_OUTPUT_DIR, use the default one ${NC}"
...
if [ -n "${VIRTUAL_ENV}" ]; then
  ...
  echo -e "${red} ${double_arrow} Undefined parameter ${head_skull} ${NC}"
...
if [ -n "${ANSIBLE_CMD}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_CMD, use the default one ${NC}"
...
if [ -n "${ANSIBLE_CMBD_CMD}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_CMBD_CMD, use the default one ${NC}"
...
if [ -n "${ANSIBLE_GALAXY_CMD}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_GALAXY_CMD, use the default one ${NC}"
  # if virtualenv is not used and there is system installation
  # of python3, it should be used
...
if [ -n "${ANSIBLE_PLAYBOOK_CMD}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_PLAYBOOK_CMD, use the default one ${NC}"
  # if virtualenv is not used and there is system installation
  # of python3, it should be used
...
if [ -n "${ANSIBLE_LINT_CMD}" ]; then
  ...
  echo -e "${yellow} ${double_arrow} Undefined parameter ${head_skull} : ANSIBLE_LINT_CMD, use the default one ${NC}"
  # if virtualenv is not used and there is system installation
  # of python3, it should be used
